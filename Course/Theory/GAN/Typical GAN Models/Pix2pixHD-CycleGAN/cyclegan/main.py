...
def main():
    ...
    if FLAGS.train:
        ...
        print(os.path.join(FLAGS.data_dir, FLAGS.dataset))
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Learning GAN with PyTorch')
    ...
    parser.add_argument('--data_dir', type=str, default='~/Data/image_transfer', help='Directory for dataset.')
