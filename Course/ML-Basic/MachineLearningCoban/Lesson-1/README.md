...
1. Machine learning là gì ???????
    ...
    Copy từ đây nè: https://khanh-personal.gitbook.io/ml-book-vn/machine-learning-la-gi
    ...
    ![Hình 1](https://github.com/lacie-life/ML-basic/blob/master/Lesson1/img/classification1.png?raw=true)
    ...
    Simulation: (https://www.youtube.com/watch?time_continue=13&v=vGwemZhPlsA&feature=emb_logo)
    ...
    ![Hình 2](https://github.com/lacie-life/ML-basic/blob/master/Lesson1/img/clasification-hard.png?raw=true)
    ...
    Simulation: (https://www.youtube.com/watch?time_continue=2&v=m4J2WLOvrHg&feature=emb_logo)
    ...
    ![Hình 3](https://github.com/lacie-life/ML-basic/blob/master/Lesson1/img/khainimcoban.PNG?raw=true)
